...
class LocalScheduler(AbstractScheduler):
    ...
    def submit(self, job_id, experiment_name, experiment_dir, database_address, gml_filename, labels, output):
        base_path = os.path.dirname(os.path.realpath(spearmint.__file__))
        cmd = ('python %s/launcher.py --database-address %s --experiment-name %s --job-id %s --gml %s --labels %s' % 
               (base_path, database_address, experiment_name, job_id, gml_filename, labels))
