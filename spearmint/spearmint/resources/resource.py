...
class Resource(object):
    ...
    def attemptDispatch(self, experiment_name, job, db_address, expt_dir, gml_filename, labels, output):
        ...
        process_id = self.scheduler.submit(job['id'], experiment_name, expt_dir, db_address, gml_filename, labels, output)
