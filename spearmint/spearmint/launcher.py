...
def main():
    ...
    parser.add_option("--gml", "-g", dest="gml_filename",
              help="gml file to load.",
              type="string", default="embedded_karate.gml")
    ...
    launch(options.db_address, options.experiment_name, options.job_id, options.gml_filename, options.labels)

def launch(db_address, experiment_name, job_id, gml_filename, labels):
    """
    ...
    try:
        if job['language'].lower() == 'matlab':
            ...
            result = python_launcher(job, gml_filename, labels)
...
def python_launcher(job, gml_filename, labels):
    ...
    result = module.main(job['id'], params, gml_filename, labels, 1000)
